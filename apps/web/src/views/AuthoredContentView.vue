...
<template>
  <div>
    ...
    <ion-segment :value="activeTab" @ionChange="activeTab = ($event.detail.value as 'analysts' | 'instruments' | 'wiring')">
      <ion-segment-button value="analysts">
        <ion-label>Analysts</ion-label>
      </ion-segment-button>
      <ion-segment-button value="instruments">
