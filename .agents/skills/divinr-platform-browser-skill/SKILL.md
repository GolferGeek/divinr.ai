...
|---|---|---|
| `predictions` | `.Codex/skills/divinr-predictions-browser-skill/` | Analyses list, role filter, detail drawer, trade-CTA hand-off |
| `portfolios` | `.Codex/skills/divinr-portfolios-browser-skill/` | Portfolio dashboard, equity curve, positions, P&L |
| `tournaments` | `.Codex/skills/divinr-tournaments-browser-skill/` | Tournaments list, detail tabs (INFO/TRADE/LEADERBOARD/MY POSITIONS), trade form, leaderboard |
| `clubs` | `.Codex/skills/divinr-clubs-browser-skill/` | Clubs list, detail, rankings, compare, curriculum |
| `analysts` | `.Codex/skills/divinr-analysts-browser-skill/` | Analysts list, performance, contract editor |
| `instruments` | `.Codex/skills/divinr-instruments-browser-skill/` | Instruments list, detail, contract editor |
| `performance` | `.Codex/skills/divinr-performance-browser-skill/` | Performance dashboard (cross-facet aggregates) |
